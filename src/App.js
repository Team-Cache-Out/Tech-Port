...
function App() {
  ...
  const houston = () => {
    ...
    fetch(
      `https://worldwide-technical-foundation.herokuapp.com/campusTickets/1/working`
    )
      .then((response) => response.json())
  ...
  const arizona = () => {
    ...
    fetch(
      `https://worldwide-technical-foundation.herokuapp.com/campusTickets/2/working`
    )
      .then((response) => response.json())
  ...
  const oregon = () => {
    ...
    fetch(
      `https://worldwide-technical-foundation.herokuapp.com/campusTickets/3/working`
    )
      .then((response) => response.json())
  ...
  const pepperdine = () => {
    ...
    fetch(
      `https://worldwide-technical-foundation.herokuapp.com/campusTickets/4/working`
    )
      .then((response) => response.json())
  ...
  return (
    <Router>
      <Routes>
        ...
        ></Route>
        <Route exact path="/admin" element={<AdminLandingPage />}></Route>
        <Route
          exact
          path="/ticketBoard"
          element={
