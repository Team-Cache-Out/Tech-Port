...
export default function SingleTicketModal() {
    ...
    const noteSubmit = (e) => {
        ...
        fetch(`https://techport-m8h0.onrender.com/notes/${ticket.ticket_id}`, fetchData)
    ...
    const statusUpdate = (e) => {
        ...
        fetch(`https://techport-m8h0.onrender.com/status/${ticket.ticket_id}`, fetchData)
            .then(() => { handleClose() })
    }
    ...
    const assign = (e) => {
        ...
        fetch(`https://techport-m8h0.onrender.com/assign/${ticket.ticket_id}`, fetchData)
            .then(() => { handleClose() })
            .catch(error => {
                console.error(error)
            })
    ...
    const claim = (e) => {
        ...
        fetch(`https://techport-m8h0.onrender.com/assign/${singleTicket.ticket_id}`, fetchData)
            .then(() => { handleClose() })
            .catch(error => {
                console.error(error)
            })
