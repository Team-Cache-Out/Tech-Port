...
export default function Tech(props) {
    ...
    const handleAdminClick = (e) => {
        ...
        fetch(`https://techport-m8h0.onrender.com/users/${id}`, {
            method: 'PATCH',
            body: JSON.stringify({
                'role': 'admin'
            }),
    ...
    return (
        <div id={props.elem.user_id}>
            <div className="TechContainer">
                ...
                <div className="TechContainerInnerRight"><button className="GrantAdmin" id={props.elem.user_id} onClick={handleAdminClick} disabled>Grant Admin</button></div>
            </div>
        </div>
    )
}