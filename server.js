...
app.post("/tickets", async (req,res) => {
    try {
        ...
        const data = client.query("INSERT INTO tickets (problem, description, point_of_contact, location, priority, status, university_id) VALUES ($1, $2, $3, $4, $5, $6, $7);", [req.body.problem, req.body.description, req.body.point_of_contact, req.body.location, req.body.priority, req.body.status, req.body.university_id]);
